...
<nav class="bg-light-gray fixed w-full z-20 top-0 start-0 border-b border-gray-200">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-light-gray md:space-x-8
            rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
        <li>
            <router-link :to="{ name: 'home' }" class="block py-2 px-3 text-dark-gray rounded md:bg-transparent md:text-dark-gray md:p-0 md:dark:text-dark-gray" aria-current="page">
                Home
            </router-link>
        </li>
        <li>
            <router-link :to="{ name: 'home' }" class="block py-2 px-3 text-dark-gray rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0
        ...
        <li>
            <router-link :to="{ name: 'home' }" class="block py-2 px-3 text-dark-grayrounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0
            md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                Create Event
            </router-link>
        </li>
